package cn.ucaner.skeleton.opencv.common.utils.kit;
 ...
 * @Package：cn.ucaner.skeleton.opencv.common.utils.kit
 * @Description： <p> OcUtils - 汇总utils  </p>
 * @Author： - Jason
 * @CreatTime：2019/8/21 - 11:04
 * @Modify By：
 * @ModifyTime： 2019/8/21
 * @Modify marker：
 */
public class OcUtils {
    ...
    public static class Base {
        ...
        public static Mat shiftSaturability(Mat mat, int val) {
            ...
            cvtColor(mat, hsv, Imgproc.COLOR_BGR2HSV);
            ...
            Mat ret = new Mat();
            cvtColor(hsv, ret, Imgproc.COLOR_HSV2BGR);
            return ret;
        }
    ...
    */
    public static class Filter {
        ...
        public static Mat oilPainting(Mat img) {
            ...
            Imgproc.GaussianBlur(img, img, new Size(11, 11), 20, 20, BORDER_DEFAULT);
            for (int i = 0; i < img.height(); i++) {
                for (int j = 0; j < img.width(); j++) {
