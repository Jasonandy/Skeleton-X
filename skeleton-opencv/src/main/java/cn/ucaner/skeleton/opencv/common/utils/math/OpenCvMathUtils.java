package cn.ucaner.skeleton.opencv.common.utils.math;
 ...
 * @Package：cn.ucaner.skeleton.opencv.common.utils.math
 * @Description： <p> OpenCvMathUtils </p>
 * @Author： - Jason
 * @CreatTime：2019/8/20 - 11:57
 * @Modify By：
 * @ModifyTime： 2019/8/20
 * @Modify marker：
 */
public class OpenCvMathUtils {

    /**
     * 把open_cv的灰度图Mat转化为List<List<Double>>即数组对象
