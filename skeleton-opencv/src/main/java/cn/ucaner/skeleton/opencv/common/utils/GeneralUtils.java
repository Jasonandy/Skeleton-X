 ...
 * @Package：cn.ucaner.skeleton.opencv.common.utils
 * @Description： <p> GeneralUtils </p>
 * @Author： - Jason
 * @CreatTime：2019/8/20 - 11:33
 * @Modify By：
...
public class GeneralUtils {
     ...
     * 设置归一化图像的固定大小
     */
    private static final Size d_size = new Size(32, 32);
    ...
    public static Mat erodeDilateImg(Mat src) {
        ...
        /**
         * 膨胀
         *  图像的一部分区域与指定的核进行卷积， 求核的最`大`值并赋值给指定区域。 膨胀可以理解为图像中`高亮区域`的'领域扩大'。
    ...
    /**
     * canny算法，边缘检测 @See https://blog.csdn.net/Jamence/article/details/84645554
     * @param src
     * @return
     */
    ...
    public static void main(String[] args) {
        ...
        Mat canny = GeneralUtils.canny(mat);
        GeneralUtils.saveImg(canny,"C:\\Users\\Jason's-PC\\Pictures\\avatar\\0001.jpeg");
